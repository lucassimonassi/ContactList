...
class ContactAdapter(context: Context, private val contactList: MutableList<Contact>):
    ...
    //getview cria e infla uma célula, como também trocar o valor dessa célula inflada
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        val holder = contactTileView.tag as TileContactBinding
    ...
    private data class TileContactHolder(var nameTv: TextView, var emailTv: TextView)
}